...
const MetadataFilterDropdown = ({menuText, eventSchemaId}: {menuText: string; eventSchemaId: number}) => {
  ...
  return (
    <Menu isOpen={isOpen} onClose={onClose}>
      ...
      <MenuList px={4} onClick={handleClick} background="#2D3748" borderColor="rgb(255,255,255,0.16)" >
        <MetadataFilterForm eventSchemaId={eventSchemaId} onClose={onClose}/>
      </MenuList>
    </Menu>
  );
};
